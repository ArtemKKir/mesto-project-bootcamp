...
export const createPlaceButton = placeForm.querySelector('.form_place');
...
export {openPopupButtonElement, closePopupButton, add, closePlacePopup, body, newPlaceUrl, newPlaceName, form, nameInput, jobInput, nameField, jobField}